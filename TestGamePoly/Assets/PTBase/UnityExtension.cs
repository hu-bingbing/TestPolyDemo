...
public static class UnityExtension
{
    ...
    /// </summary>
    /// <typeparam name="T">要获取或增加的组件。</typeparam>
    /// <param name="tComponent">目标组件。</param>
    /// <returns>获取或增加的组件。</returns>
    public static T GetOrAddComponent<T>(this Component tComponent) where T : Component
    {
        T component = tComponent.GetComponent<T>();
        if (component == null)
        {
            component = tComponent.gameObject.AddComponent<T>();
        }
